...
if __name__ == '__main__':
    ...
    # from play import eval_digits_all,eval_rectangles_all,train_rectangle_all, train_digits_all
    # eval_rectangles_all()
    # eval_digits_all()
    # train_rectangle_all(10, False, False)
    # train_rectangle_all(8, True, False)
    # train_digits_all(10, False, True)
    # train_digits_all(8, True, False)
    play.play()
